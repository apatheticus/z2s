...
/* A folded lane. Only the summary needs saying: everything else the lane
   already styles, which is why the instructions cost one rule rather than a
   component. */
.pf > summary{cursor:pointer;list-style:none}
.pf > summary::-webkit-details-marker{display:none}
.pf > summary::before{content:"\25B8  ";display:inline-block;transition:transform .12s}
.pf[open] > summary::before{content:"\25BE  "}
...
@media print{
  ...
  /* Instructions are dropped rather than expanded. Paper cannot be copied
     from, and 173 sets of them would be the whole document. */
